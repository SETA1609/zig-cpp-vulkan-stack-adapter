...
VkResult vma_bridge_create_allocator(VkInstance instance, VkPhysicalDevice physical,
...
VkResult vma_bridge_create_buffer(VmaBridgeAllocator a, const VkBufferCreateInfo* info,
                                  VmaBridgeUsage usage, uint32_t flags, uint64_t* out_buffer,
                                  VmaBridgeAllocation* out_alloc) noexcept;
void vma_bridge_destroy_buffer(VmaBridgeAllocator a, uint64_t buffer,
                               VmaBridgeAllocation alloc) noexcept;

VkResult vma_bridge_create_image(VmaBridgeAllocator a, const VkImageCreateInfo* info,
                                 VmaBridgeUsage usage, uint32_t flags, uint64_t* out_image,
                                 VmaBridgeAllocation* out_alloc) noexcept;
void vma_bridge_destroy_image(VmaBridgeAllocator a, uint64_t image,
                              VmaBridgeAllocation alloc) noexcept;

VkResult vma_bridge_map_memory(VmaBridgeAllocator a, VmaBridgeAllocation alloc,
...
void vma_bridge_get_allocation_info(VmaBridgeAllocator a, VmaBridgeAllocation alloc,
                                    uint32_t* out_memory_type, uint64_t* out_device_memory,
...
VkResult vma_bridge_flush_allocation(VmaBridgeAllocator a, VmaBridgeAllocation alloc,
                                     uint64_t offset, uint64_t size) noexcept;
VkResult vma_bridge_invalidate_allocation(VmaBridgeAllocator a, VmaBridgeAllocation alloc,
                                          uint64_t offset, uint64_t size) noexcept;
